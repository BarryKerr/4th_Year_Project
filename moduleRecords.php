...
if(isset($_COOKIE["username"])) {
    ...
    ?>
    <form method="POST" action="addModule.php" name="Login_Form" class="form-signin">
        <h3 class="form-signin-heading">Add New Module</h3>
        <hr class="colorgraph">
        <br>
        <input name="module_id" type="text" class="form-control" placeholder="Module ID" required=""
               autofocus=""/><br><br>
        <input name="name" type="text" class="form-control" placeholder="Name" required=""/><br><br>
        <input name="Lecturer_ID" type="text" class="form-control" placeholder="Lecturer ID" required=""/><br><br>

        <button class="btn btn-primary btn-lg btn-block" name="Submit" value="Login" type="Submit">Add new Module
        </button>
    </form>
    </body>
    </html>
