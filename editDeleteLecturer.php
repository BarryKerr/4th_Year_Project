...
if(isset($_COOKIE["username"])) {
    ...
    echo "<h2 align='center'>Update or Delete Lecturer Record</h2>";
...
<th colspan=\"2\">OPTIONS</th>
    ...
    while($row = $query->fetch()) {
        echo("<form method=\"post\" action=\"updateLecturer.php\">  ");
        echo "<tr>";
        echo "<td><input type='text' name='lecturerID' value='" . $row['Lecturer_ID'] . "' /></td>";
        ...
        echo('<td><button><a href="deleteLecturer.php?id=' . $row['Lecturer_ID'] . '">Delete</a></button></td>');
        echo ('</form>');
        echo ('</tr>');
    }
    echo "</table>";
